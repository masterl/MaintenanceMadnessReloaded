...
data:extend( {
    ...
    },
    {
        ...
        effects = { { type = 'unlock-recipe', recipe = 'mm-recycler' } },
        order = 'c-c-e'
    },
    {
        type = 'technology',
        ...
        effects = {
            { type = 'unlock-recipe', recipe = 'mm-toolbox' }
        ...
        effects = {
            {
                type = 'nothing',
                effect_description = {
                    'mm-effect-basic-maintenance-bonus',
                    mmUtil.round(
                        internalSettings.techBoni['improvedMaintenanceAccess'][1]
                            .basicMaintenanceBonus * 100, 1 )
                }
            }
        },
        upgrade = true,
        ...
        effects = {
            {
                ...
                effect_description = {
                    'mm-effect-basic-maintenance-bonus',
                    mmUtil.round(
                        internalSettings.techBoni['improvedMaintenanceAccess'][2]
                            .basicMaintenanceBonus * 100, 1 )
                }
            },
            {
                type = 'nothing',
                effect_description = {
                    'mm-effect-basic-repair-speed-bonus',
                    mmUtil.round(
                        internalSettings.techBoni['improvedMaintenanceAccess'][2]
                            .basicRepairSpeedBonus * 100, 1 )
                }
            }
        },
        upgrade = true,
    ...
    },
    {
        ...
        icon_size = 128,
        prerequisites = {
            'mm-improved-maintenance-access-2',
        ...
        effects = {
            {
                ...
                effect_description = {
                    'mm-effect-basic-maintenance-bonus',
                    mmUtil.round(
                        internalSettings.techBoni['improvedMaintenanceAccess'][3]
                            .basicMaintenanceBonus * 100, 1 )
                }
            },
            {
