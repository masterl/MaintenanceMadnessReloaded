data:extend({
{
    ...
    minable = {mining_time = 1, result = "mm-recycler"},
    max_health = 300,
    ...
    crafting_categories = {"mm-recycling"},
    ...
    animation =
    {
      ...
      {
        {
          filename = "__maintenance-madness-reloaded__/graphics/entities/recycler.png",
          priority = "high",
          width = 107,
          height = 113,
          frame_count = 1,
          ...
          hr_version =
          {
            filename = "__maintenance-madness-reloaded__/graphics/entities/hr-recycler.png",
            priority = "high",
            width = 214,
            height = 225,
            frame_count = 1,
        ...
        {
          filename = "__maintenance-madness-reloaded__/graphics/entities/recycler-shadow.png",
          priority = "high",
          width = 98,
          height = 82,
          frame_count = 1,
          ...
          hr_version =
          {
            filename = "__maintenance-madness-reloaded__/graphics/entities/hr-recycler-shadow.png",
            priority = "high",
            width = 196,
            height = 163,
            frame_count = 1,
    ...
    working_visualisations = {
        {
			animation =
			{
				filename = "__maintenance-madness-reloaded__/graphics/entities/recycler-propeller.png",
				priority = "high",
				width = 19,
				height = 13,
				frame_count = 4,
				...
				hr_version =
				{
					filename = "__maintenance-madness-reloaded__/graphics/entities/hr-recycler-propeller.png",
					priority = "high",
					width = 37,
					height = 25,
					frame_count = 4,
  ...
  },
{
    ...
    minable = {mining_time = 0.2, result = "mm-simple-maintenance-unit"},
    max_health = 250,
    ...
    picture =
    {
      ...
      {
        {
          filename = "__maintenance-madness-reloaded__/graphics/entities/simple-maintenance-unit.png",
          priority = "extra-high",
          width = 35,
          height = 42,
          ...
          hr_version =
          {
            filename = "__maintenance-madness-reloaded__/graphics/entities/hr-simple-maintenance-unit.png",
            priority = "extra-high",
            width = 70,
            height = 84,
        ...
        {
          filename = "__maintenance-madness-reloaded__/graphics/entities/simple-maintenance-unit-shadow.png",
          priority = "extra-high",
          width = 56,
          height = 22,
          ...
          hr_version =
          {
            filename = "__maintenance-madness-reloaded__/graphics/entities/hr-simple-maintenance-unit-shadow.png",
            priority = "extra-high",
            width = 110,
            height = 46,
