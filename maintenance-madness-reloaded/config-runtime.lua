...
const.MTBM = math.floor( 3600 *
                             settings.global['mm-mean-time-between-maintenance-events']
                                 .value )

-- mean time to maintain
const.MTTM = math.floor(
                 3600 * settings.global['mm-mean-time-to-maintain'].value )

-- mean time to repair
const.MTTR =
    math.floor( 3600 * settings.global['mm-mean-time-to-repair'].value )

-- expected life time of a machine, assuming servicing always at 100%
const.expectedLifeTime = math.floor( 3600 * 60 *
...
-- ageing per cycle
const.baseAgeing = math.ceil( 100 * const.maxAge /
...
const.idleWearReductionFactor = settings.global['mm-wear-reduction-if-idle']
                                    .value / 100
...
const.showMIPsignForSolar =
    settings.global['mm-show-maintenance-in-progress-sign-for-solar'].value
...
const.lowTechModifierTarget = settings.global['mm-low-tech-bonus-target-tech']
                                  .value
...
const.repairItemPriority = { 'mm-toolbox', 'repair-pack' }
...
const.entityDefaultRepairDemandByType = {
    ...
    ['furnace'] = { { name = 'mm-mechanical-spare-parts', amount = 1 } },
    ['solar-panel'] = { { name = 'mm-electronical-spare-parts', amount = 1 } },
    ['accumulator'] = { { name = 'mm-electronical-spare-parts', amount = 1 } },
    ['reactor'] = { { name = 'mm-electronical-spare-parts', amount = 8 } },
    ['boiler'] = { { name = 'mm-mechanical-spare-parts', amount = 1 } },
    ['generator'] = { { name = 'mm-mechanical-spare-parts', amount = 2 } },
    ['mining-drill'] = { { name = 'mm-mechanical-spare-parts', amount = 1 } },
    ['roboport'] = { { name = 'mm-electronical-spare-parts', amount = 3 } },
    ['beacon'] = { { name = 'mm-electronical-spare-parts', amount = 1 } },
    ['lab'] = { { name = 'mm-electronical-spare-parts', amount = 1 } }
}
